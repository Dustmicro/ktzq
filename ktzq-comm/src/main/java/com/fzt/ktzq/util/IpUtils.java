...
public class IpUtils {
    ...
    public static void main(String[] args) throws SocketException, UnknownHostException {
        ...
        System.out.println( "新方式-----------hostAddress = "+IpUtils.getLocalIp4Address());
    }
    ...
    public static String getLocalIp4Address() throws SocketException {
        ...
        if (inet4Addresses.size() != 1) {
            ...
            if (ipBySocketOpt.isPresent()) {
                return ipBySocketOpt.get().toString().replaceAll("/","");
            } else {
                return inet4Addresses.isEmpty() ? Optional.empty().get().toString().replaceAll("/","")
                        : Optional.of(inet4Addresses.get(0)).get().toString().replaceAll("/","");
            }
        }
        return Optional.of(inet4Addresses.get(0)).get().toString().replaceAll("/","");
    }
}
