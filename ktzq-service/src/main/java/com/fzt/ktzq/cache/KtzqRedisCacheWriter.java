...
///**
// * 自定义redis 缓存器
// * @author 黄弋峰 2022/12/16
// */
//public class KtzqRedisCacheWriter implements RedisCacheWriter {
//
//
...
//     */
//    KtzqRedisCacheWriter(RedisConnectionFactory connectionFactory) {
...
//     *                          to disable locking.
//     */
//    KtzqRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
//
...
//            int index = name.lastIndexOf(KtzqRedisConfig.REDIS_EXPIRE_TIME_KEY);
//            if (index > 0) {
//                //取出对应的时间 1200 index + 1是还有一个=号
//                String expireString = name.substring(index + 1 + KtzqRedisConfig.REDIS_EXPIRE_TIME_KEY.length());
